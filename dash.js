...
break
   ...
   if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: freply})
               list = []
               listmenu = [`groupmenu`,`photoky`,`ephoto`,`imageefek`,`randomimage`,`wibu2`,`storymenu`,`randomtext`,`islammenu`,`wibumenu`,`stickermenu`,`ownermenu`,`gamemenu`,`funmenu`,`downloadmenu`,`infomenu`,`othermenu`,`owner`,`dashgroup`,`sewabot`,`allmenu`]
               listmenuu = [`Menu Group`,`Photo Oky`,`Ephoto Menu`,`imageefek`,`Random Image`,`Wibu Menu`,`Movie&Story`,`RandomText`,`Islam Menu`,`Wibu Menu`,`Sticker Menu`,`Owner Command`,`Game Menu`,`For Fun Menu`,`Downloader`,`Info Menu`,`Menu Lainnya`,`OwnerBot`,`Official Group`,`Rent this Bot`,`All Menu`]
               nombor = 1
               startnum = 0
