...
*Antero*`
	    ...
	    reply(`*Terimakasih Telah Terdaftar Di Antero*`)
	}, 2000)
	}
	    // Auto Read
...
ship.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
    ...
    case 'help':  
            ...
            teksnya = `${namabot}`
  buttons = [{buttonId: `${prefix}owner`,buttonText:{displayText: `👥 OWNER`},type:1}, { buttonId: `${prefix}command`, buttonText: { displayText: 'MENU' }, type: 1 }]
      ...
      case 'broadcast3':
             ...
             for (let _ of anu) {
             ship.sendMessage(_.jid, { contentText: `*🌹 SIARAN Antero 🌹*\n\n${body.slice(4)}`, footerText: '©Created by Antero', buttons: [{ buttonId: `${prefix}allmenu`, buttonText: { displayText: 'MENU' }, type: 1 }, { buttonId: `${prefix}`, buttonText: { displayText: 'OWNER' }, type: 1 }], headerType: 6, locationMessage: { degreesLatitude: 0, degreesLongitude: 0, jpegThumbnail: bc2 }}, 'buttonsMessage')
}
...
case 'chiisaihentai':
                ...
                if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: freply})
              buff = await getBuffer(`https://api.lolhuman.xyz/api/random/nsfw/${command}?apikey=codexteam`)
              buttons = [{buttonId: `${prefix + command}`,buttonText:{displayText: `➡️Next`},type:1}]
              imageMsg = (await ship.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'©Created by Antero', imageMessage: imageMsg,
              ...
              ship.relayWAMessage(prep)
                ...
                case 'nsfw_avatar':
                if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: freply})
               buff = await getBuffer(`https://api.lolhuman.xyz/api/random2/${command}?apikey=codexteam`)
                buttons = [{buttonId: `${prefix + command}`,buttonText:{displayText: `➡️Next`},type:1}]
              imageMsg = (await ship.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'©Created by Antero', imageMessage: imageMsg,
              ...
              ship.relayWAMessage(prep)
                ...
                if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: freply})
                    ...
                    ini_txt = args.join(" ")
                    getBuffer(`https://api.lolhuman.xyz/api/textprome/${command}?apikey=codexteam&text=${ini_txt}`).then((gambar) => {
                ...
                if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: freply})
                    ...
                    txt1 = args[0]
                    txt2 = args[1]
                    getBuffer(`https://api.lolhuman.xyz/api/textprome2/${command}?apikey=codexteam&text1=${txt1}&text2=${txt2}`).then((gambar) => {
                        ship.sendMessage(from, gambar, image, {thumbnail: Buffer.alloc(0), caption: `subrekyt aing : https://short.dobf.xyz/ytaing`, quoted : freply})
                    })
                    break
                ...
                if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: freply})
                    if (args.length == 0) return reply(`Example: ${prefix + command} LoL Human`)
                    ini_txt = args.join(" ")
                    getBuffer(`https://api.lolhuman.xyz/api/photooxy1/${command}?apikey=codexteam&text=${ini_txt}`).then((gambar) => {
                        ship.sendMessage(from, gambar, image, {thumbnail: Buffer.alloc(0), caption: `subrekyt aing : https://short.dobf.xyz/ytaing`, quoted : freply})
                    })
                    break
                case 'tiktok':
                ...
                if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: freply})
                    ...
                    txt1 = args[0]
                    txt2 = args[1]
                    getBuffer(`https://api.lolhuman.xyz/api/photooxy2/${command}?apikey=codexteam&text1=${txt1}&text2=${txt2}`).then((gambar) => {
                        ship.sendMessage(from, gambar, image, {thumbnail: Buffer.alloc(0), caption: `subrekyt aing : https://short.dobf.xyz/ytaing`, quoted : freply})
                    })
                    break
                ...
                if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: freply})
                    if (args.length == 0) return reply(`Example: ${prefix + command} LoL Human`)
                    ini_txt = args.join(" ")
                    getBuffer(`https://api.lolhuman.xyz/api/ephoto1/${command}?apikey=codexteam&text=${ini_txt}`).then((gambar) => {
                        ship.sendMessage(from, gambar, image, {thumbnail: Buffer.alloc(0), caption: `subrekyt aing : https://short.dobf.xyz/ytaing`, quoted : freply}) 
                    })
                    break
                    case 'linkgc':
      ...
      case 'broadcast2':
             ...
             for (let _ of anu) {
             ship.sendMessage(_.jid, bc, image, {quoted:freply,caption: `*「 SIARAN Antero 」*\n\n${body.slice(4)}`})
}
             reply('Suksess broadcast')
             } else {
             for (let _ of anu) {
ship.sendMessage(_.jid, 
	    {"contentText": `*「 SIARAN Antero 」*\n\n${body.slice(4)}`,
	    "footerText": '©Created by Antero',
	    "buttons": [
	    {"buttonId": `!owner`,
...
break
                ...
                case 'quotesdilan':
                if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: freply})
                    get_result = await fetchJson(`https://api.lolhuman.xyz/api/quotes/diLan?apikey=codexteam`)
                ...
                case 'quotesimage':
                if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: freply})
                    get_result = await getBuffer(`https://api.lolhuman.xyz/api/random/${command}?apikey=codexteam`)
                ...
                case 'bucin':
                if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: freply})
                    get_result = await fetchJson(`https://api.lolhuman.xyz/api/random/${command}?apikey=codexteam`)
       ...
       // Movie & Story
                ...
                if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: freply})
                    ...
                    query = args.join(" ")
                    get_result = await fetchJson(`https://api.lolhuman.xyz/api/lk21?apikey=codexteam&query=${query}`)
                ...
                case 'drakorongoing':
                if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: freply})
                    get_result = await fetchJson(`https://api.lolhuman.xyz/api/drakorongoing?apikey=codexteam`)
                    get_result = get_result.result
                ...
                if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: freply})
                    ...
                    ini_url = args[0]
                    get_result = await fetchJson(`https://api.lolhuman.xyz/api/wattpad?apikey=codexteam&url=${ini_url}`)
                    get_result = get_result.result
                    ini_txt = `Title : ${get_result.title}\n`
                    ini_txt += `Rating : ${get_result.rating}\n`
                ...
                if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: freply})
                    ...
                    query = args.join(" ")
                    get_result = await fetchJson(`https://api.lolhuman.xyz/api/wattpadsearch?apikey=codexteam&query=${query}`)
                    get_result = get_result.result
                ...
                case 'cerpen':
                if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: freply})
                    get_result = await fetchJson(`https://api.lolhuman.xyz/api/cerpen?apikey=codexteam`)
                    get_result = get_result.result
                    ini_txt = `Title : ${get_result.title}\n`
        ...
        break;
                ...
                case 'ceritahoror':
                if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: freply})
                    get_result = await fetchJson(`https://api.lolhuman.xyz/api/ceritahoror?apikey=codexteam`)
                    get_result = get_result.result
                    ini_txt = `Title : ${get_result.title}\n`
                    ini_txt += `Desc : ${get_result.desc}\n`
                    ini_txt += `Story :\n${get_result.story}\n`
   ...
   if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: freply})
               list = []
               listmenu = [`groupmenu`,`photoky`,`ephoto`,`imageefek`,`randomimage`,`wibu2`,`storymenu`,`SEDANG DALAM PENGEMBANGAN`,`randomtext`,`islammenu`,`wibumenu`,`stickermenu`,`ownermenu`,`gamemenu`,`funmenu`,`downloadmenu`,`infomenu`,`othermenu`,`owner`,`dashgroup`,`sewabot`,`allmenu`]
               listmenuu = [`Menu Group`,`Photo Oky`,`Ephoto Menu`,`imageefek`,`Random Image`,`Wibu Menu`,`Movie&Story`,`SEDANG DALAM PENGEMBANGAN`,`RandomText`,`Islam Menu`,`Wibu Menu`,`Sticker Menu`,`Owner Command`,`Game Menu`,`For Fun Menu`,`Downloader`,`Info Menu`,`Menu Lainnya`,`OwnerBot`,`Official Group`,`Rent this Bot`,`All Menu`]
               nombor = 1
               startnum = 0
               ...
               listmsg(from, `*${ucapanWaktu}*`,`Halo kak ${pushname} \nketuk pilih disini untuk memilih menu yang anda inginkan`, list)
               break
               case 'groupmenu':
        case 'menugroup':
        if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: freply})
...
Platform : *${os.platform()}*
 ...
 ©Created by Antero`, imageMessage: imageMsg,
               buttons: buttons,
               headerType: 1
}
...
Kalau mau sewa Antero chat *OWNER* yah
`
...
// Islami //
                case 'listsurah':
                if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: freply})
                    get_result = await fetchJson(`https://api.lolhuman.xyz/api/quran?apikey=codexteam`)
                    get_result = get_result.result
                    ini_txt = 'List Surah:\n'
                ...
                if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: freply})
                    ...
                    urls = `https://api.lolhuman.xyz/api/quran/${args[0]}?apikey=codexteam`
                ...
                if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: freply})
                    ...
                    surah = args[0]
                    ini_buffer = await getBuffer(`https://api.lolhuman.xyz/api/quran/audio/${surah}?apikey=codexteam`)
                    await ship.sendMessage(from, ini_buffer, audio, { quoted: freply, mimetype: Mimetype.mp4Audio })
                    break
                case 'asmaulhusna':
                if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: freply})
                    get_result = await fetchJson(`https://api.lolhuman.xyz/api/asmaulhusna?apikey=codexteam`)
                    get_result = get_result.result
                ...
                if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: freply})
                    ...
                    query = args.join(" ")
                    get_result = await fetchJson(`https://api.lolhuman.xyz/api/kisahnabi/${query}?apikey=codexteam`)
                    get_result = get_result.result
                ...
                if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: freply})
                    ...
                    daerah = args.join(" ")
                    get_result = await fetchJson(`https://api.lolhuman.xyz/api/sholat/${daerah}?apikey=codexteam`)
                    get_result = get_result.result
...
break
			...
			if (!isOwner) return reply(`Kamu bukan owner say:v`)
				...
				ship.sendMessage(from, `Sukses Menambahkan Vn ke dalam database\nSilahkann Cek dengan cara ${prefix}listvn`, MessageType.text, { quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg", "caption": "_Self Antero_", "fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=", "fileLength": "28777", "height": 1080, "width": 1079, "mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=", "fileEncSha256": "sR9D2RS5JStw49HeBADguI23fWDz1aZu4faWG/CyRY=", "directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69", "mediaKeyTimestamp": "1610993486", "jpegThumbnail": fs.readFileSync('./media/Menu.jpg')} }} }) 
				break
			case 'getvn':
...
Ket : Ketik /resetgame , Untuk Mereset Permainan Yg Ada Di Grup!`, text, {contextInfo: {mentionedJid: [player2]}})
     ...
     if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: freply})
       titid =  `SILAHKAN PILIH DI BAWAH UNTUK MELANJUTKAN`
                   ...
                   sendButMessage(from, titid, `©Created by Antero`, [
          {
            buttonId: `Y`,
            buttonText: {
              displayText: `Y`,
       ...
       if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: freply})
              ...
              anu = await axios.get(`http://api.lolhuman.xyz/api/tebak/family100?apikey=codexteam`)
       ...
       if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: freply})
              ...
              get_result = await fetchJson(`https://lolhuman.herokuapp.com/api/tebakchara?apikey=codexteam`)
              get_result = get_result.result
       ...
       if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: freply})
              ...
              get_result = await fetchJson(`https://lolhuman.herokuapp.com/api/tebak/siapaaku?apikey=codexteam`)
              get_result = get_result.result
       ...
       if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: freply})
              ...
              get_result = await fetchJson(`https://lolhuman.herokuapp.com/api/tebak/kata?apikey=codexteam`)
              get_result = get_result.result
              jawaban = get_result.jawaban
       ...
       if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: freply})
              ...
              get_result = await fetchJson(`https://lolhuman.herokuapp.com/api/tebak/lirik?apikey=codexteam`)
              get_result = get_result.result
              jawaban = get_result.answer
              kisi_kisi = jawaban.replace(/[b|c|d|f|g|h|j|k|l|m|n|p|q|r|s|t|v|w|x|y|z]/gi, '_')
              pertanyaan = get_result.question
      ...
      if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: freply})
              ...
              get_result = await fetchJson(`https://lolhuman.herokuapp.com/api/tebak/jenaka?apikey=codexteam`)
              get_result = get_result.result
              jawaban = get_result.answer
              kisi_kisi = jawaban.replace(/[b|c|d|f|g|h|j|k|l|m|n|p|q|r|s|t|v|w|x|y|z]/gi, '_')
              pertanyaan = get_result.question
       ...
       if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: freply})
              ...
              get_result = await fetchJson(`https://lolhuman.herokuapp.com/api/tebak/unsurkimia?apikey=codexteam`)
              get_result = get_result.result
       ...
       if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: freply})
              ...
              get_result = await fetchJson(`https://lolhuman.herokuapp.com/api/tebak/bendera?apikey=codexteam`)
              get_result = get_result.result
              jawaban = get_result.name
              kisi_kisi = jawaban.replace(/[b|c|d|f|g|h|j|k|l|m|n|p|q|r|s|t|v|w|x|y|z]/gi, '_')
       ...
       if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: freply})
              ...
              get_result = await fetchJson(`https://lolhuman.herokuapp.com/api/tebak/susunkata?apikey=codexteam`)
              get_result = get_result.result
              jawaban = get_result.jawaban
              pertanyaan = get_result.pertanyaan
       ...
       if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: freply})
              ...
              get_result = await fetchJson(`https://lolhuman.herokuapp.com/api/tebak/asahotak?apikey=codexteam`)
              get_result = get_result.result
              jawaban = get_result.jawaban
              kisi_kisi = jawaban.replace(/[b|c|d|f|g|h|j|k|l|m|n|p|q|r|s|t|v|w|x|y|z]/gi, '_')
              pertanyaan = get_result.pertanyaan
       ...
       if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: freply})
              ...
              get_result = await fetchJson(`https://lolhuman.herokuapp.com/api/tebak/caklontong2?apikey=codexteam`)
              get_result = get_result.result
              jawaban = get_result.answer
              kisi_kisi = jawaban.replace(/[b|c|d|f|g|h|j|k|l|m|n|p|q|r|s|t|v|w|x|y|z]/gi, '_')
              pertanyaan = get_result.question
...
//------------------< Downloader/Search/Anime >-------------------
       ...
       if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: freply})
              ...
              reply(mess.wait)
              anu = await fetchJson(`https://api.lolhuman.xyz/api/soundcloud?apikey=codexteam&url=${q}`)
...
ship.sendMessage(from,{url:'./'+dasyy},audio,{mimetype:'audio/mpeg'})
       ...
       if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: freply})
              ...
              data = await fetchJson(`https://api.lolhuman.xyz/api/tiktok?apikey=codexteam&url=${q}`)
...
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: freply})
  ...
  if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: freply})
      ...
      if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: freply})
             ...
             ini_link = args[0]
             get_audio = await getBuffer(`https://api.lolhuman.xyz/api/tiktokmusic?apikey=codexteam&url=${ini_link}`)
      ...
      if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: freply})
       ...
       if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: freply})
             ...
             try {
             henid = args[0]
             get_result = await fetchJson(`https://api.lolhuman.xyz/api/nhentai/${henid}?apikey=codexteam`)
             get_result = get_result.result
...
🐤 Character : ${get_info.characters.join(", ")}\n`
             ...
             reply(mess.wait)
             anu = await fetchJson(`https://api.lolhuman.xyz/api/nhentaipdf/${henid}?apikey=codexteam`)
       ...
       if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: freply})
              ...
              reply(mess.wait)
              query = args.join(" ")
              get_result = await fetchJson(`https://api.lolhuman.xyz/api/manga?apikey=codexteam&query=${query}`)
              get_result = get_result.result
      ...
      if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: freply})
             ...
             reply(mess.wait)
             query = args.join(" ")
             get_result = await fetchJson(`https://api.lolhuman.xyz/api/anime?apikey=codexteam&query=${query}`)
             get_result = get_result.result
             ini_txt = `Id : ${get_result.id}\n`
             ini_txt += `Id MAL : ${get_result.idMal}\n`
             ini_txt += `Title : ${get_result.title.romaji}\n`
      ...
      if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: freply})
             ...
             reply(mess.wait)
             query = args.join(" ")
             get_result = await fetchJson(`https://api.lolhuman.xyz/api/kusonimesearch?apikey=codexteam&query=${query}`)
             get_result = get_result.result
             ini_txt = `Title : ${get_result.title}\n`
       ...
       if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: freply})
              ...
              reply(mess.wait)
              query = args.join(" ")
              get_result = await fetchJson(`https://api.lolhuman.xyz/api/otakudesusearch?apikey=codexteam&query=${query}`)
              get_result = get_result.result
              ini_txt = `Title : ${get_result.title}\n`
              ini_txt += `Japanese : ${get_result.japanese}\n`
       ...
       if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: freply})
              ...
              ini_url = args[0]
              get_result = await fetchJson(`https://api.lolhuman.xyz/api/nekopoi?apikey=codexteam&url=${ini_url}`)
              get_result = get_result.result
       ...
       if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: freply})
              ...
              query = args.join(" ")
              get_result = await fetchJson(`https://api.lolhuman.xyz/api/nekopoisearch?apikey=codexteam&query=${query}`)
              get_result = get_result.result
              ini_txt = ""
              for (var x of get_result) {
              ini_txt += `\`\`\`◧ Title : ${x.title}\`\`\`\n`
       ...
       if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: freply})
              reply(mess.wait)
              buff = await getBuffer(`https://api.lolhuman.xyz/api/random/${command}?apikey=codexteam`)
              buttons = [{buttonId: `${prefix + command}`,buttonText:{displayText: `➡️Next`},type:1}]
              imageMsg = (await ship.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'©Created by Antero', imageMessage: imageMsg,
              contentText:`klik Next untuk ke gambar selanjut nya`,buttons,headerType:4}
       ...
       if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: freply})
              reply(mess.wait)
              buff = await getBuffer(`https://api.lolhuman.xyz/api/random/nsfw/hentai?apikey=codexteam`)
              buttons = [{buttonId: `${prefix + command}`,buttonText:{displayText: `➡️Next`},type:1}]
              imageMsg = (await ship.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'©Created by Antero', imageMessage: imageMsg,
              contentText:`klik Next untuk ke gambar selanjut nya`,buttons,headerType:4}
       ...
       case 'storyanime':
              if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: freply})
              reply(mess.wait)
              anu = await fetchJson(`https://lolhuman.herokuapp.com/api/storynime?apikey=codexteam`)
...
break
          ...
          if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: freply})
                    ...
                    query = args.join(" ")
                    get_result = await fetchJson(`https://api.lolhuman.xyz/api/lirik?apikey=codexteam&query=${query}`)
                    reply(get_result.result)
         ...
         if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: freply})
		   if (args.length == 0) return reply(`Example: ${prefix + command} loli`)
                    query = args.join(" ")
                 reply (mess.wait)
                    ini_url = await fetchJson(`http://api.lolhuman.xyz/api/pinterest?apikey=codexteam&query=${query}`)
...
//------------------< Level >-------------------
      case 'level': 
              ...
              buffer = await getBuffer(`https://lolhuman.herokuapp.com/api/rank?apikey=codexteam&img=${profilePic}&background=https://telegra.ph/file/443b6600636aed1d94acd.jpg&username=${encodeURI(pushname)}&level=${userLevel}&ranking=${Number(userRank)}&currxp=${userXp}&xpneed=${requiredXp}`)
...
//------------------< Stalk >-------------------
      ...
      if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: freply})
              ...
              reply(mess.wait)
              username = args[0]
              ini_result = await fetchJson(`https://api.lolhuman.xyz/api/github/${username}?apikey=codexteam`)
...
`
      ...
      case 'igstalk':
             ...
             reply(mess.wait)
             username = args[0]
             ini_result = await fetchJson(`https://api.lolhuman.xyz/api/stalkig/${username}?apikey=codexteam`)
             ini_result = ini_result.result
...
`
      ...
      if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: freply})
             ...
             reply(mess.wait)
             stalk_toktok = args[0]
             get_result = await fetchJson(`http://lolhuman.herokuapp.com/api/stalktiktok/${stalk_toktok}?apikey=codexteam`)
             get_result = get_result.result
...
//------------------< Sticker/Tools >-------------------
      ...
      if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: freply})
       ...
       if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: freply})
              ...
              ini_buffer = await getBuffer(`https://api.lolhuman.xyz/api/smoji/${emoji}?apikey=codexteam`)
...
default:
if (budy.includes(`codexteam`)) {
                const bot = fs.readFileSync('./assets/codexteam.mp3');
